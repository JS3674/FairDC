...
parser.add_argument('--return_metrics', action='store_true', help='Whether to return metrics instead of printing them')
...
def all_metrics(top_k): 
    ...
    for epoch in ['best']: 
        ...
        if args.return_metrics:
            return hr_test, ndcg_test, DP_test, EO_test
...
def gender_metrics(top_k):
    ...
    for epoch in ['best']: 
        ...
        if args.return_metrics:
            return hr_male, ndcg_male, hr_female, ndcg_female
